...
Nous suivons les aventures du chasseur de primes isolé dans la bordure extérieure de la galaxie, loin de l'autorité de la Nouvelle République.", 'Sciencefiction', "themandalorian", '2'],
        ['Toujours là pour toi', "L'une est riche et célèbre. L'autre a l'amour et la famille. Ces amies de toujours sont aussi différentes que possible.", 'Comedie', "toujourslapourtoi", '3'],
